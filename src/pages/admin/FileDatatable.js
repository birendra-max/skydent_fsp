...
export default function FileDatatable({
    ...
    const fetchPage = async (url) => {
        ...
        try {
            // ✅ Use base_url for constructing absolute URL
            let fullUrl = url;
    ...
    const handlePageNumberClick = (pageNum) => {
        ...
        if (nextPage || previousPage) {
            ...
            // ✅ Use base_url for constructing URL
            if (base_url) {
    ...
    const handleBulkDownload = () => {
        ...
        selectedRows.forEach((id) => {
            ...
            // ✅ UPDATED: Use different file paths based on fileType like CasesDatatable
    ...
    const handleDelete = async (orderid, fname) => {
        const token = localStorage.getItem('skydent_admin_token');
        try {
            // ✅ Use base_url for delete endpoint
                        ...
                        <>
                            ...
                            {selectedRows.length > 0 && (
                                ...
                                >
                                    ...
                                    {/* ✅ ADDED: File type selector like in CasesDatatable */}
                                    <select
                                        value={fileType}
